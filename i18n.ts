...
const resources = {
  en: {
    translation: {
      ...
      description:
        'Manage entry permissions, monitor issues, and stay informed—all from a single, intuitive app.',
      signIn: 'Sign In',
      signOut: 'Sign Out',
  ...
  de: {
    translation: {
      ...
      description:
        'Verwalten Sie Zutrittsberechtigungen, überwachen Sie Probleme und bleiben Sie informiert – alles in einer einzigen, intuitiven App.',
      signIn: 'Anmelden',
      signOut: 'Abmelden',
      ...
      permissionMessage:
        'Wir benötigen Ihre Erlaubnis, um die Kamera zum Scannen des QR-Codes anzuzeigen',
      allow: 'Erlauben',
      scanQR: 'QR scannen',
