  ...
  return (
    <Card elevate bordered theme="red">
      ...
      <View mx="$4" gap="$2" mb="$4">
        <StatisticItem label={t('statistics.pending')} count={pending} status="pending" />
        <StatisticItem label={t('statistics.success')} count={success} status="success" />
        <StatisticItem label={t('statistics.failed')} count={failed} status="failed" />
      </View>
